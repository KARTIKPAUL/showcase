...
export default function SuperwomenShowcase() {
  ...
  const shareText =
    "Check out SuperWomen.live, a platform dedicated to empowering women across Maharashtra.";
  ...
  const galleryImages = [
    {
      src: "/images/ShowCase/superwomen/superwomen-home.png",
      alt: "SuperWomen Website Homepage Design",
      title: "Super Women - Landing Page Overview",
      description:
        "Engaging homepage highlighting key sections and featured stories of remarkable women",
      category: "Homepage Design",
    },
    {
      src: "/images/ShowCase/superwomen/superwomen-category.png",
      alt: "Women's Health Information Portal",
      title: "Comprehensive Women's Health Section",
      description:
        "Detailed health resources and information portal tailored for women's wellness",
      category: "Content Category",
    },
    {
      src: "/images/ShowCase/superwomen/superwomen-maharashtra-category.png",
      alt: "Maharashtra Region Women's Achievements",
      title: "Women Empowerment in Maharashtra",
      description:
        "Curated section featuring outstanding women from Maharashtra state",
      category: "Regional Showcase",
    },
    {
      src: "/images/ShowCase/superwomen/superwomen-gondia-category.png",
      alt: "Regional Content Section for Gondia",
      title: "Gondia Region Women's Stories",
      description:
        "Localized content highlighting women's achievements in the Gondia region",
      category: "Regional Content",
    },
    {
      src: "/images/ShowCase/superwomen/superwomen-individual-article.png",
      alt: "Detailed Article Layout for Women's Stories",
      title: "Super Women - In-Depth Article Interface",
      description:
        "Comprehensive article page showcasing individual women's achievements and narratives",
      category: "Article Layout",
    },
    {
      src: "/images/ShowCase/superwomen/superwomen-popup-form.png",
      alt: "User Registration and Subscription Popup",
      title: "Newsletter Signup Form",
      description:
        "Interactive popup form for user registration and newsletter subscription",
      category: "User Interaction",
    },

    {
      src: "/images/ShowCase/superwomen/superwomen-footer.png",
      alt: "Website Footer with Navigation and Contact Information",
      title: "Site-Wide Footer Design",
      description:
        "Comprehensive footer section with site navigation, social links, and contact details",
  ...
  const features = [
    {
      ...
      description:
        "Inspiring narratives of women breaking barriers and achieving excellence",
    },
    {
      icon: "📰",
      title: "Regional News",
      description:
        "Latest updates from Maharashtra focused on women's achievements",
    },
    {
      icon: "🌿",
      title: "Health & Wellness",
      description:
        "Resources and articles dedicated to women's health and wellbeing",
    },
    {
      icon: "🌾",
      title: "Agricultural Insights",
      description:
        "Highlighting women's contributions to farming and sustainable practices",
    },
    {
      icon: "📚",
      title: "Literary Platform",
      description:
        "Showcase for women authors and poets to share their creative works",
    },
    {
      icon: "🎯",
      title: "Social Awareness",
      description:
        "Campaigns and initiatives promoting gender equality and social justice",
    },
  ];

  // Stats
  const stats = [
    { label: "Monthly Visitors", value: "2,800+" },
    { label: "Articles Published", value: "87+" },
    { label: "Featured Women", value: "5,000+" },
  ...
  const handleShare = async () => {
    if (navigator.share) {
      ...
      const shareLink = `https://www.addtoany.com/share#url=${encodeURIComponent(
        shareUrl
    ...
    <>
      <div className="min-h-screen text-black dark:text-white">
        ...
        <section className="relative overflow-hidden">
          <div className="relative mx-auto mt-10 max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
            <motion.div
            ...
            >
              ...
              <iframe
                  ref={playerRef}
                  src="https://www.youtube.com/embed/BdSn001dTas?si=2gmS4eY6eKXqbce9&enablejsapi=1&controls=0&origin"
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-black/30 opacity-100 transition-opacity duration-300 group-hover:opacity-100">
                  <button
                    onClick={toggleVideo}
                    className="flex h-20 w-20 items-center justify-center rounded-full bg-[#ff0033] text-white transition-transform duration-300 hover:scale-110"
                  >
                    {isVideoPlaying ? (
        ...
        {/* Navigation Tabs */}
        <section className="sticky top-16 z-10 mx-auto max-w-7xl border-b border-purple-900/50 bg-[#1a0033]/80 backdrop-blur-md">
          <div className=" px-4 sm:px-6 lg:px-8">
            <div className="scrollbar-hide flex overflow-x-auto py-4">
        ...
        <div className="relative mx-auto max-w-7xl overflow-hidden px-4 py-12 sm:px-6 lg:px-8">
          <div className="absolute inset-0 overflow-hidden">
            <div className="absolute -right-20 -top-20 h-64 w-64 rounded-full bg-[#ff0099] opacity-10 blur-3xl"></div>
          ...
          {activeTab === "overview" && (
            ...
            >
              <div className="space-y-8">
                <div>
                  <h2 className="text-3xl font-bold text-[#ff66cc]">
                    About the Platform
                  </h2>
                  <p className="mt-4  dark:text-purple-100/80">
                    ...
                    Maharashtra. This comprehensive portal features regional
                    updates, in-depth articles, interviews, and resources
                    specifically designed to inspire and inform its audience.
                  </p>
                  <p className="mt-4 dark:text-purple-100/80">
                    The platform showcases stories of women excelling in various
                    fields, providing role models for the community and creating
                    a space where achievements are celebrated and challenges are
                    addressed.
                  </p>
                </div>

                <div>
                  <h3 className="text-xl font-semibold text-[#ff66cc]">
                    Project Details
                  </h3>
            ...
            >
              <div className="text-center">
                ...
                <p className="mx-auto mt-4 max-w-2xl dark:text-purple-100/80">
                  Explore the visual elements and key sections of the
                  SuperWomen.live platform through this interactive gallery.
                </p>
              </div>
          ...
          {activeTab === "features" && (
            ...
            >
              <div className="text-center">
                ...
                <p className="mx-auto mt-4 max-w-2xl dark:text-purple-100/80">
                  SuperWomen.live offers a comprehensive set of features
                  designed to empower, inform, and connect women across
                  Maharashtra.
                </p>
              </div>
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {features.map((feature, index) => (
                  ...
                  >
                    ...
                    <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-[#ff0099] text-xl dark:bg-[#ff0099]/20">
                      {feature.icon}
                    </div>
                    ...
                    <p className="dark:text-purple-100/80 ">
                      {feature.description}
                    </p>
              ...
              <div className="rounded-2xl bg-gradient-to-r from-[#ff0099]/20 to-[#9900ff]/20 p-8">
                <div className="grid gap-8 md:grid-cols-2">
                  <div>
                    ...
                    <p className="mt-4 dark:text-purple-100/80">
                      SuperWomen.live is built on WordPress with custom themes
                      and plugins to create a seamless user experience. The
                      platform features responsive design, optimized
                      performance, and multilingual support to reach a wider
                      audience.
                    </p>
                  ...
                  <div className="flex items-center justify-center">
                    <div className="relative h-64 w-64">
                      <div className="absolute inset-0 flex animate-pulse items-center justify-center rounded-full bg-[#ff0099]/20">
                        <div className="h-48 w-48 animate-pulse rounded-full bg-[#9900ff]/20 delay-300">
          ...
          {activeTab === "stats" && (
            ...
            >
              <div className="text-center">
                ...
                <p className="mx-auto mt-4 max-w-2xl dark:text-purple-100/80">
                  SuperWomen.live has made a significant impact in empowering
                  women across Maharashtra through digital content and community
                  building.
                </p>
              </div>
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                {stats.map((stat, index) => (
                  <motion.div
                    ...
                    animate={{ opacity: 1, scale: 1 }}
                    transition={{ delay: index * 0.1, duration: 0.5 }}
                    className="group relative overflow-hidden rounded-xl bg-gradient-to-br from-purple-100 to-purple-200 p-6 text-center backdrop-blur-sm transition-all hover:-translate-y-1 hover:shadow-lg hover:shadow-[#ff0099]/10 dark:from-purple-900/40 dark:to-purple-800/20"
                  >
                    <div className="absolute -right-6 -top-6 h-24 w-24 rounded-full blur-2xl transition-all dark:bg-[#ff0099]/10 dark:group-hover:bg-[#ff0099]/20"></div>
              ...
              <div className="rounded-2xl bg-gradient-to-r from-[#ff0099]/20 to-[#9900ff]/20 p-8">
                <div className="grid gap-8 md:grid-cols-2">
                  <div>
                    ...
                    <p className="mt-4 dark:text-purple-100/80">
                      The platform has successfully highlighted numerous women
                      achievers from various fields, creating role models for
                      the community. From farmers to entrepreneurs, artists to
                      scientists, SuperWomen.live has documented inspiring
                      journeys that motivate others.
                    </p>
                    <div className="mt-6 space-y-4">
                      <div className="rounded-lg bg-purple-900/30 p-4">
                        <p className="italic text-purple-100/90">
                          "SuperWomen.live gave me a platform to share my
                          agricultural innovations, connecting me with other
                          women farmers across Maharashtra."
                        </p>
                        <p className="mt-2 text-right text-sm font-medium dark:text-[#ff66cc]">
                          — Sunita Patil, Farmer
                        </p>
                      </div>
                      <div className="rounded-lg bg-purple-900/30 p-4">
                        <p className="italic text-purple-100/90">
                          "Being featured on this platform helped me reach a
                          wider audience for my literary works and connect with
                          other Marathi authors."
                        </p>
                        <p className="mt-2 text-right text-sm font-medium dark:text-[#ff66cc]">
                          — Priya Joshi, Author
                        </p>
                    ...
                    <div className="space-y-4">
                      <div>
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-sm font-medium text-[#ff66cc]">
                            85%
                          </span>
                        </div>
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-7xl rounded-2xl bg-gradient-to-r from-[#1a0033]/80 to-[#2d0033]/80 p-8 text-center backdrop-blur-md sm:p-12">
              <h2 className="text-3xl font-bold text-white">
                Experience SuperWomen.live
              </h2>
              <p className="mx-auto mt-4 max-w-xl text-purple-100/80">
                Visit the platform to explore inspiring stories, regional news,
                and resources dedicated to empowering women across Maharashtra.
              </p>
              <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
                ...
                <button
                  onClick={handleShare}
                  className="inline-flex items-center rounded-full bg-purple-900/50 px-8 py-3 font-medium text-white transition-all hover:bg-purple-900/70"
                >
              ...
              <div className="mt-8 flex items-center justify-center gap-4">
                <button
                  onClick={handleShare}
                  className="flex items-center justify-center rounded-full bg-purple-900/30 p-3 text-white transition-all hover:bg-purple-900/50"
                >
